...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://localhost:5432/appliedjob"
...
from myapp.applied_jobs.views import applied_jobs
app.register_blueprint(applied_jobs)